...
# postgresql
sudo -u postgres psql postgres -c "create user restful with password 'restful';"
sudo -u postgres psql postgres -c "alter user restful with superuser;"
sudo -u postgres psql postgres -c 'alter user restful with createdb;'
